...
class Loader(object):
    ...
    """
    def __init__(self, gram_dump_path_input: str, gram_dump_path_output: str, word_dump_path: str):
        ...
        self.word_vocabulary = WordVocabulary(word_dump_path)  # type: WordVocabulary
